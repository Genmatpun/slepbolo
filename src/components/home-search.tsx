...
export function HomeSearch() {
  ...
  return (
    <div className="flex max-w-[920px] flex-wrap items-center gap-1 rounded-[--radius-lg] border border-linea bg-carta p-2 shadow-[var(--shadow-morbida)]">
      <Field label="Zona">
        <select
          value={zona}
...
function Field({ label, children }: { label: string; children: React.ReactNode }) {
  return (
    <div className="min-w-0 flex-1 basis-[170px] rounded-2xl px-4 py-2.5 transition hover:bg-crema">
